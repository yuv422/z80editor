...
public class Z80Instruction {
    ...
    static {
        ...
        map.put(0x8EDD, new Z80Instruction(Z80OpCodes.ADC, "ADC A, (IX+nn)", 0x8EDD, "8EDD(*1)", 3, 19, 19, 0, 0));
        map.put(0x8EFD, new Z80Instruction(Z80OpCodes.ADC, "ADC A, (IY+nn)", 0x8EFD, "8EFD(*1)", 3, 19, 19, 0, 0));
        ...
        map.put(0xCE, new Z80Instruction(Z80OpCodes.ADC, "ADC A, nn", 0xCE, "CE(*1)", 2, 7, 8, 0, 0));
        ...
        map.put(0x86DD, new Z80Instruction(Z80OpCodes.ADD, "ADD A, (IX+nn)", 0x86DD, "86DD(*1)", 3, 19, 19, 0, 0));
        map.put(0x86FD, new Z80Instruction(Z80OpCodes.ADD, "ADD A, (IY+nn)", 0x86FD, "86FD(*1)", 3, 19, 19, 0, 0));
        ...
        map.put(0xC6, new Z80Instruction(Z80OpCodes.ADD, "ADD A, nn", 0xC6, "C6(*1)", 2, 7, 8, 0, 0));
        ...
        map.put(0xA6DD, new Z80Instruction(Z80OpCodes.AND, "AND (IX+nn)", 0xA6DD, "A6DD(*1)", 3, 19, 19, 0, 0));
        map.put(0xA6FD, new Z80Instruction(Z80OpCodes.AND, "AND (IY+nn)", 0xA6FD, "A6FD(*1)", 3, 19, 19, 0, 0));
        ...
        map.put(0xE6, new Z80Instruction(Z80OpCodes.AND, "AND nn", 0xE6, "E6(*1)", 2, 7, 8, 0, 0));

        map.put(0x46CB, new Z80Instruction(Z80OpCodes.BIT, "BIT n, (HL)", 0x46CB, "46CB", 2, 12, 12, 0, 0));
        map.put(0xCBDD4600, new Z80Instruction(Z80OpCodes.BIT, "BIT n, (IX+nn)", 0xCBDD4600, "CBDD 4600", 4, 20, 20, 0, 0));
        map.put(0xCBFD4600, new Z80Instruction(Z80OpCodes.BIT, "BIT n, (IY+nn)", 0xCBFD4600, "CBFD 4600", 4, 20, 20, 0, 0));
        map.put(0x47CB, new Z80Instruction(Z80OpCodes.BIT, "BIT n, A", 0x47CB, "47CB", 2, 8, 8, 0, 0));
        map.put(0x40CB, new Z80Instruction(Z80OpCodes.BIT, "BIT n, B", 0x40CB, "40CB", 2, 8, 8, 0, 0));
        map.put(0x41CB, new Z80Instruction(Z80OpCodes.BIT, "BIT n, C", 0x41CB, "41CB", 2, 8, 8, 0, 0));
        map.put(0x42CB, new Z80Instruction(Z80OpCodes.BIT, "BIT n, D", 0x42CB, "42CB", 2, 8, 8, 0, 0));
        map.put(0x43CB, new Z80Instruction(Z80OpCodes.BIT, "BIT n, E", 0x43CB, "43CB", 2, 8, 8, 0, 0));
        map.put(0x44CB, new Z80Instruction(Z80OpCodes.BIT, "BIT n, H", 0x44CB, "44CB", 2, 8, 8, 0, 0));
        map.put(0x45CB, new Z80Instruction(Z80OpCodes.BIT, "BIT n, L", 0x45CB, "45CB", 2, 8, 8, 0, 0));

        map.put(0xDC, new Z80Instruction(Z80OpCodes.CALL, "CALL C, nnnn", 0xDC, "DC(*2)", 3, 17, 17, 1, 12));
        map.put(0xFC, new Z80Instruction(Z80OpCodes.CALL, "CALL M, nnnn", 0xFC, "FC(*2)", 3, 17, 17, 1, 12));
        map.put(0xD4, new Z80Instruction(Z80OpCodes.CALL, "CALL NC, nnnn", 0xD4, "D4(*2)", 3, 17, 17, 1, 12));
        map.put(0xC4, new Z80Instruction(Z80OpCodes.CALL, "CALL NZ, nnnn", 0xC4, "C4(*2)", 3, 17, 17, 1, 12));
        map.put(0xF4, new Z80Instruction(Z80OpCodes.CALL, "CALL P, nnnn", 0xF4, "F4(*2)", 3, 17, 17, 1, 12));
        ...
        map.put(0xBEDD, new Z80Instruction(Z80OpCodes.CP, "CP (IX+nn)", 0xBEDD, "BEDD(*1)", 3, 19, 19, 0, 0));
        map.put(0xBEFD, new Z80Instruction(Z80OpCodes.CP, "CP (IY+nn)", 0xBEFD, "BEFD(*1)", 3, 19, 19, 0, 0));
        ...
        map.put(0xFE, new Z80Instruction(Z80OpCodes.CP, "CP nn", 0xFE, "FE(*1)", 2, 7, 8, 0, 0));
        ...
        map.put(0x35DD, new Z80Instruction(Z80OpCodes.DEC, "DEC (IX+nn)", 0x35DD, "35DD(*1)", 3, 23, 23, 0, 0));
        map.put(0x35FD, new Z80Instruction(Z80OpCodes.DEC, "DEC (IY+nn)", 0x35FD, "35FD(*1)", 3, 23, 23, 0, 0));
        ...
        map.put(0x10, new Z80Instruction(Z80OpCodes.DJNZ, "DJNZ nn", 0x10, "10(*1)", 2, 13, 13, 0, 0));
        ...
        map.put(0xDB, new Z80Instruction(Z80OpCodes.IN, "IN A, (nn)", 0xDB, "DB(*1)", 2, 12, 12, 0, 0));

        map.put(0x34, new Z80Instruction(Z80OpCodes.INC, "INC (HL)", 0x34, "34", 1, 11, 11, 0, 0));
        map.put(0x34DD, new Z80Instruction(Z80OpCodes.INC, "INC (IX+nn)", 0x34DD, "34DD(*1)", 3, 23, 23, 0, 0));
        map.put(0x34FD, new Z80Instruction(Z80OpCodes.INC, "INC (IY+nn)", 0x34FD, "34FD(*1)", 3, 23, 23, 0, 0));
        ...
        map.put(0xDA, new Z80Instruction(Z80OpCodes.JP, "JP C, nnnn", 0xDA, "DA(*2)", 3, 10, 12, 1, 0));
        map.put(0xFA, new Z80Instruction(Z80OpCodes.JP, "JP M, nnnn", 0xFA, "FA(*2)", 3, 10, 12, 1, 0));
        map.put(0xD2, new Z80Instruction(Z80OpCodes.JP, "JP NC, nnnn", 0xD2, "D2(*2)", 3, 10, 12, 1, 0));
        map.put(0xC2, new Z80Instruction(Z80OpCodes.JP, "JP NZ, nnnn", 0xC2, "C2(*2)", 3, 10, 12, 1, 0));
        map.put(0xF2, new Z80Instruction(Z80OpCodes.JP, "JP P, nnnn", 0xF2, "F2(*2)", 3, 10, 12, 1, 0));
        map.put(0xEA, new Z80Instruction(Z80OpCodes.JP, "JP PE, nnnn", 0xEA, "EA(*2)", 3, 10, 12, 1, 0));
        map.put(0xE2, new Z80Instruction(Z80OpCodes.JP, "JP PO, nnnn", 0xE2, "E2(*2)", 3, 10, 12, 1, 0));
        map.put(0xCA, new Z80Instruction(Z80OpCodes.JP, "JP Z, nnnn", 0xCA, "CA(*2)", 3, 10, 12, 1, 0));
        map.put(0xC3, new Z80Instruction(Z80OpCodes.JP, "JP nnnn", 0xC3, "C3(*2)", 3, 10, 12, 0, 0));

        map.put(0x38, new Z80Instruction(Z80OpCodes.JR, "JR C, nn", 0x38, "38(*1)", 2, 10, 10, 7, 8));
        map.put(0x30, new Z80Instruction(Z80OpCodes.JR, "JR NC, nn", 0x30, "30(*1)", 2, 10, 10, 7, 8));
        map.put(0x20, new Z80Instruction(Z80OpCodes.JR, "JR NZ, nn", 0x20, "20(*1)", 2, 10, 10, 7, 8));
        map.put(0x28, new Z80Instruction(Z80OpCodes.JR, "JR Z, nn", 0x28, "28(*1)", 2, 10, 10, 7, 8));
        map.put(0x18, new Z80Instruction(Z80OpCodes.JR, "JR nn", 0x18, "18(*1)", 2, 10, 10, 0, 0));
        ...
        map.put(0x36, new Z80Instruction(Z80OpCodes.LD, "LD (HL), nn", 0x36, "36(*1)", 2, 10, 12, 0, 0));

        map.put(0x77DD, new Z80Instruction(Z80OpCodes.LD, "LD (IX+nn), A", 0x77DD, "77DD(*1)", 3, 19, 19, 0, 0));
        map.put(0x70DD, new Z80Instruction(Z80OpCodes.LD, "LD (IX+nn), B", 0x70DD, "70DD(*1)", 3, 19, 19, 0, 0));
        map.put(0x71DD, new Z80Instruction(Z80OpCodes.LD, "LD (IX+nn), C", 0x71DD, "71DD(*1)", 3, 19, 19, 0, 0));
        map.put(0x72DD, new Z80Instruction(Z80OpCodes.LD, "LD (IX+nn), D", 0x72DD, "72DD(*1)", 3, 19, 19, 0, 0));
        map.put(0x73DD, new Z80Instruction(Z80OpCodes.LD, "LD (IX+nn), E", 0x73DD, "73DD(*1)", 3, 19, 19, 0, 0));
        map.put(0x74DD, new Z80Instruction(Z80OpCodes.LD, "LD (IX+nn), H", 0x74DD, "74DD(*1)", 3, 19, 19, 0, 0));
        map.put(0x75DD, new Z80Instruction(Z80OpCodes.LD, "LD (IX+nn), L", 0x75DD, "75DD(*1)", 3, 19, 19, 0, 0));
        map.put(0x36DD, new Z80Instruction(Z80OpCodes.LD, "LD (IX+nn), nn", 0x36DD, "36DD(*2)", 4, 19, 20, 0, 0));

        map.put(0x77FD, new Z80Instruction(Z80OpCodes.LD, "LD (IY+nn), A", 0x77FD, "77FD(*1)", 3, 19, 19, 0, 0));
        map.put(0x70FD, new Z80Instruction(Z80OpCodes.LD, "LD (IY+nn), B", 0x70FD, "70FD(*1)", 3, 19, 19, 0, 0));
        map.put(0x71FD, new Z80Instruction(Z80OpCodes.LD, "LD (IY+nn), C", 0x71FD, "71FD(*1)", 3, 19, 19, 0, 0));
        map.put(0x72FD, new Z80Instruction(Z80OpCodes.LD, "LD (IY+nn), D", 0x72FD, "72FD(*1)", 3, 19, 19, 0, 0));
        map.put(0x73FD, new Z80Instruction(Z80OpCodes.LD, "LD (IY+nn), E", 0x73FD, "73FD(*1)", 3, 19, 19, 0, 0));
        map.put(0x74FD, new Z80Instruction(Z80OpCodes.LD, "LD (IY+nn), H", 0x74FD, "74FD(*1)", 3, 19, 19, 0, 0));
        map.put(0x75FD, new Z80Instruction(Z80OpCodes.LD, "LD (IY+nn), L", 0x75FD, "75FD(*1)", 3, 19, 19, 0, 0));
        map.put(0x36FD, new Z80Instruction(Z80OpCodes.LD, "LD (IY+nn), nn", 0x36FD, "36FD(*2)", 4, 19, 20, 0, 0));

        map.put(0x32, new Z80Instruction(Z80OpCodes.LD, "LD (nnnn), A", 0x32, "32(*2)", 3, 13, 16, 0, 0));
        map.put(0x43ED, new Z80Instruction(Z80OpCodes.LD, "LD (nnnn), BC", 0x43ED, "43ED(*2)", 4, 20, 20, 0, 0));
        map.put(0x53ED, new Z80Instruction(Z80OpCodes.LD, "LD (nnnn), DE", 0x53ED, "53ED(*2)", 4, 20, 20, 0, 0));
        map.put(0x22, new Z80Instruction(Z80OpCodes.LD, "LD (nnnn), HL", 0x22, "22(*2)", 3, 20, 20, 0, 0));
        map.put(0x22FD, new Z80Instruction(Z80OpCodes.LD, "LD (nnnn), IY", 0x22FD, "22FD(*2)", 4, 20, 20, 0, 0));
        map.put(0x73ED, new Z80Instruction(Z80OpCodes.LD, "LD (nnnn), SP", 0x73ED, "73ED(*2)", 4, 20, 20, 0, 0));
        map.put(0x22DD, new Z80Instruction(Z80OpCodes.LD, "LD (nnnn), IX", 0x22DD, "22DD(*2)", 4, 20, 20, 0, 0));
        ...
        map.put(0x7EFD, new Z80Instruction(Z80OpCodes.LD, "LD A, (IY+nn)", 0x7EFD, "7EFD(*1)", 3, 19, 19, 0, 0));
        map.put(0x7EDD, new Z80Instruction(Z80OpCodes.LD, "LD A, (IX+nn)", 0x7EDD, "7EDD(*1)", 3, 19, 19, 0, 0));
        map.put(0x3A, new Z80Instruction(Z80OpCodes.LD, "LD A, (nnnn)", 0x3A, "3A(*2)", 3, 13, 16, 0, 0));
        ...
        map.put(0x3E, new Z80Instruction(Z80OpCodes.LD, "LD A, nn", 0x3E, "3E(*1)", 2, 7, 8, 0, 0));

        map.put(0x46, new Z80Instruction(Z80OpCodes.LD, "LD B, (HL)", 0x46, "46", 1, 7, 8, 0, 0));
        map.put(0x46DD, new Z80Instruction(Z80OpCodes.LD, "LD B, (IX+nn)", 0x46DD, "46DD(*1)", 3, 19, 19, 0, 0));
        map.put(0x46FD, new Z80Instruction(Z80OpCodes.LD, "LD B, (IY+nn)", 0x46FD, "46FD(*1)", 3, 19, 19, 0, 0));
        ...
        map.put(0x06, new Z80Instruction(Z80OpCodes.LD, "LD B, nn", 0x06, "06(*1)", 2, 7, 8, 0, 0));

        map.put(0x4E, new Z80Instruction(Z80OpCodes.LD, "LD C, (HL)", 0x4E, "4E", 1, 7, 7, 0, 0));
        map.put(0x4EDD, new Z80Instruction(Z80OpCodes.LD, "LD C, (IX+nn)", 0x4EDD, "4EDD(*1)", 3, 19, 19, 0, 0));
        map.put(0x4EFD, new Z80Instruction(Z80OpCodes.LD, "LD C, (IY+nn)", 0x4EFD, "4EFD(*1)", 3, 19, 19, 0, 0));
        ...
        map.put(0x0E, new Z80Instruction(Z80OpCodes.LD, "LD C, nn", 0x0E, "0E(*1)", 2, 7, 8, 0, 0));

        map.put(0x56, new Z80Instruction(Z80OpCodes.LD, "LD D, (HL)", 0x56, "56", 1, 7, 8, 0, 0));
        map.put(0x56DD, new Z80Instruction(Z80OpCodes.LD, "LD D, (IX+nn)", 0x56DD, "56DD(*1)", 3, 19, 19, 0, 0));
        map.put(0x56FD, new Z80Instruction(Z80OpCodes.LD, "LD D, (IY+nn)", 0x56FD, "56FD(*1)", 3, 19, 19, 0, 0));
        ...
        map.put(0x16, new Z80Instruction(Z80OpCodes.LD, "LD D, nn", 0x16, "16(*1)", 2, 7, 8, 0, 0));

        map.put(0x5E, new Z80Instruction(Z80OpCodes.LD, "LD E, (HL)", 0x5E, "5E", 1, 7, 8, 0, 0));
        map.put(0x5EDD, new Z80Instruction(Z80OpCodes.LD, "LD E, (IX+nn)", 0x5EDD, "5EDD(*1)", 3, 19, 19, 0, 0));
        map.put(0x5EFD, new Z80Instruction(Z80OpCodes.LD, "LD E, (IY+nn)", 0x5EFD, "5EFD(*1)", 3, 19, 19, 0, 0));
        ...
        map.put(0x1E, new Z80Instruction(Z80OpCodes.LD, "LD E, nn", 0x1E, "1E(*1)", 2, 7, 8, 0, 0));

        map.put(0x66, new Z80Instruction(Z80OpCodes.LD, "LD H, (HL)", 0x66, "66", 1, 7, 8, 0, 0));
        map.put(0x66DD, new Z80Instruction(Z80OpCodes.LD, "LD H, (IX+nn)", 0x66DD, "66DD(*1)", 3, 19, 19, 0, 0));
        map.put(0x66FD, new Z80Instruction(Z80OpCodes.LD, "LD H, (IY+nn)", 0x66FD, "66FD(*1)", 3, 19, 19, 0, 0));
        ...
        map.put(0x26, new Z80Instruction(Z80OpCodes.LD, "LD H, nn", 0x26, "26(*1)", 2, 7, 8, 0, 0));

        map.put(0x6E, new Z80Instruction(Z80OpCodes.LD, "LD L, (HL)", 0x6E, "6E", 1, 7, 7, 0, 0));
        map.put(0x6EDD, new Z80Instruction(Z80OpCodes.LD, "LD L, (IX+nn)", 0x6EDD, "6EDD(*1)", 3, 19, 19, 0, 0));
        map.put(0x6EFD, new Z80Instruction(Z80OpCodes.LD, "LD L, (IY+nn)", 0x6EFD, "6EFD(*1)", 3, 19, 19, 0, 0));
        ...
        map.put(0x2E, new Z80Instruction(Z80OpCodes.LD, "LD L, nn", 0x2E, "2E(*1)", 2, 7, 8, 0, 0));
        ...
        map.put(0x26DD, new Z80Instruction(Z80OpCodes.LD, "LD IXH, nn", 0x26DD, "26DD(*1)", 3, 0, 0, 0, 0));
        ...
        map.put(0x26FD, new Z80Instruction(Z80OpCodes.LD, "LD IYH, nn", 0x26FD, "26FD(*1)", 3, 0, 0, 0, 0));
        ...
        map.put(0x2EDD, new Z80Instruction(Z80OpCodes.LD, "LD IXL, nn", 0x2EDD, "2EDD(*1)", 3, 0, 0, 0, 0));
        ...
        map.put(0x2EFD, new Z80Instruction(Z80OpCodes.LD, "LD IYL, nn", 0x2EFD, "2EFD(*1)", 3, 0, 0, 0, 0));

        map.put(0x4BED, new Z80Instruction(Z80OpCodes.LD, "LD BC, (nnnn)", 0x4BED, "4BED(*2)", 4, 20, 20, 0, 0));
        map.put(0x01, new Z80Instruction(Z80OpCodes.LD, "LD BC, nnnn", 0x01, "01(*2)", 3, 10, 12, 0, 0));
        map.put(0x5BED, new Z80Instruction(Z80OpCodes.LD, "LD DE, (nnnn)", 0x5BED, "5BED(*2)", 4, 20, 20, 0, 0));
        map.put(0x11, new Z80Instruction(Z80OpCodes.LD, "LD DE, nnnn", 0x11, "11(*2)", 3, 10, 12, 0, 0));
        map.put(0x2A, new Z80Instruction(Z80OpCodes.LD, "LD HL, (nnnn)", 0x2A, "2A(*2)", 3, 16, 16, 0, 0));
        map.put(0x21, new Z80Instruction(Z80OpCodes.LD, "LD HL, nnnn", 0x21, "21(*2)", 3, 10, 10, 0, 0));
        map.put(0x2ADD, new Z80Instruction(Z80OpCodes.LD, "LD IX, (nnnn)", 0x2ADD, "2ADD(*2)", 4, 20, 20, 0, 0));
        map.put(0x21DD, new Z80Instruction(Z80OpCodes.LD, "LD IX, nnnn", 0x21DD, "21DD(*2)", 4, 14, 16, 0, 0));
        map.put(0x2AFD, new Z80Instruction(Z80OpCodes.LD, "LD IY, (nnnn)", 0x2AFD, "2AFD(*2)", 4, 20, 20, 0, 0));
        map.put(0x21FD, new Z80Instruction(Z80OpCodes.LD, "LD IY, nnnn", 0x21FD, "21FD(*2)", 4, 14, 16, 0, 0));
        map.put(0x7BED, new Z80Instruction(Z80OpCodes.LD, "LD SP, (nnnn)", 0x7BED, "7BED(*2)", 4, 20, 20, 0, 0));
        ...
        map.put(0x31, new Z80Instruction(Z80OpCodes.LD, "LD SP, nnnn", 0x31, "31(*2)", 3, 10, 12, 0, 0));
        ...
        map.put(0xB6DD, new Z80Instruction(Z80OpCodes.OR, "OR (IX+nn)", 0xB6DD, "B6DD(*1)", 3, 19, 19, 0, 0));
        map.put(0xB6FD, new Z80Instruction(Z80OpCodes.OR, "OR (IY+nn)", 0xB6FD, "B6FD(*1)", 3, 19, 19, 0, 0));
        ...
        map.put(0xF6, new Z80Instruction(Z80OpCodes.OR, "OR nn", 0xF6, "F6(*1)", 2, 7, 8, 0, 0));
        ...
        map.put(0xD3, new Z80Instruction(Z80OpCodes.OUT, "OUT (nn), A", 0xD3, "D3(*1)", 2, 12, 12, 0, 0));
        ...
        map.put(0x86CB, new Z80Instruction(Z80OpCodes.RES, "RES n, (HL)", 0x86CB, "86CB", 2, 12, 12, 0, 0));
        map.put(0xCBDD8600, new Z80Instruction(Z80OpCodes.RES, "RES n, (IX+nn)", 0xCBDD8600, "CBDD 8600", 4, 20, 20, 0, 0));
        map.put(0xCBFD8600, new Z80Instruction(Z80OpCodes.RES, "RES n, (IY+nn)", 0xCBFD8600, "CBFD 8600", 4, 20, 20, 0, 0));
        map.put(0x87CB, new Z80Instruction(Z80OpCodes.RES, "RES n, A", 0x87CB, "87CB", 2, 8, 8, 0, 0));
        map.put(0x80CB, new Z80Instruction(Z80OpCodes.RES, "RES n, B", 0x80CB, "80CB", 2, 8, 8, 0, 0));
        map.put(0x81CB, new Z80Instruction(Z80OpCodes.RES, "RES n, C", 0x81CB, "81CB", 2, 8, 8, 0, 0));
        map.put(0x82CB, new Z80Instruction(Z80OpCodes.RES, "RES n, D", 0x82CB, "82CB", 2, 8, 8, 0, 0));
        map.put(0x83CB, new Z80Instruction(Z80OpCodes.RES, "RES n, E", 0x83CB, "83CB", 2, 8, 8, 0, 0));
        map.put(0x84CB, new Z80Instruction(Z80OpCodes.RES, "RES n, H", 0x84CB, "84CB", 2, 8, 8, 0, 0));
        map.put(0x85CB, new Z80Instruction(Z80OpCodes.RES, "RES n, L", 0x85CB, "85CB", 2, 8, 8, 0, 0));
        ...
        map.put(0xCBDD1600, new Z80Instruction(Z80OpCodes.RL, "RL (IX+nn)", 0xCBDD1600, "CBDD(*1)", 4, 23, 23, 0, 0));
        map.put(0xCBFD1600, new Z80Instruction(Z80OpCodes.RL, "RL (IY+nn)", 0xCBFD1600, "CBFD(*1)", 4, 23, 23, 0, 0));
        ...
        map.put(0xCBDD0600, new Z80Instruction(Z80OpCodes.RLC, "RLC (IX+nn)", 0xCBDD0600, "CBDD(*1)", 4, 23, 23, 0, 0));
        map.put(0xCBFD0600, new Z80Instruction(Z80OpCodes.RLC, "RLC (IY+nn)", 0xCBFD0600, "CBFD(*1)", 4, 23, 23, 0, 0));
        ...
        map.put(0xCBDD1E00, new Z80Instruction(Z80OpCodes.RR, "RR (IX+nn)", 0xCBDD1E00, "CBDD(*1)", 4, 23, 23, 0, 0));
        map.put(0xCBFD1E00, new Z80Instruction(Z80OpCodes.RR, "RR (IY+nn)", 0xCBFD1E00, "CBFD(*1)", 4, 23, 23, 0, 0));
        ...
        map.put(0xCBDD0E00, new Z80Instruction(Z80OpCodes.RRC, "RRC (IX+nn)", 0xCBDD0E00, "CBDD(*1)", 4, 23, 23, 0, 0));
        map.put(0xCBFD0E00, new Z80Instruction(Z80OpCodes.RRC, "RRC (IY+nn)", 0xCBFD0E00, "CBFD(*1)", 4, 23, 23, 0, 0));
        ...
        map.put(0x9EDD, new Z80Instruction(Z80OpCodes.SBC, "SBC A, (IX+nn)", 0x9EDD, "9EDD(*1)", 3, 19, 19, 0, 0));
        map.put(0x9EFD, new Z80Instruction(Z80OpCodes.SBC, "SBC A, (IY+nn)", 0x9EFD, "9EFD(*1)", 3, 19, 19, 0, 0));
        ...
        map.put(0xDE, new Z80Instruction(Z80OpCodes.SBC, "SBC A, nn", 0xDE, "DE(*1)", 2, 7, 7, 0, 0));
        ...
        map.put(0xC6CB, new Z80Instruction(Z80OpCodes.SET, "SET n, (HL)", 0xC6CB, "C6CB", 2, 15, 15, 0, 0));
        map.put(0xCBDDC600, new Z80Instruction(Z80OpCodes.SET, "SET n, (IX+nn)", 0xCBDDC600, "CBDD C600", 4, 23, 23, 0, 0));
        map.put(0xCBFDC600, new Z80Instruction(Z80OpCodes.SET, "SET n, (IY+nn)", 0xCBFDC600, "CBFD C600", 4, 23, 23, 0, 0));
        map.put(0xC7CB, new Z80Instruction(Z80OpCodes.SET, "SET n, A", 0xC7CB, "C7CB", 2, 8, 8, 0, 0));
        map.put(0xC0CB, new Z80Instruction(Z80OpCodes.SET, "SET n, B", 0xC0CB, "C0CB", 2, 8, 8, 0, 0));
        map.put(0xC1CB, new Z80Instruction(Z80OpCodes.SET, "SET n, C", 0xC1CB, "C1CB", 2, 8, 8, 0, 0));
        map.put(0xC2CB, new Z80Instruction(Z80OpCodes.SET, "SET n, D", 0xC2CB, "C2CB", 2, 8, 8, 0, 0));
        map.put(0xC3CB, new Z80Instruction(Z80OpCodes.SET, "SET n, E", 0xC3CB, "C3CB", 2, 8, 8, 0, 0));
        map.put(0xC4CB, new Z80Instruction(Z80OpCodes.SET, "SET n, H", 0xC4CB, "C4CB", 2, 8, 8, 0, 0));
        map.put(0xC5CB, new Z80Instruction(Z80OpCodes.SET, "SET n, L", 0xC5CB, "C5CB", 2, 8, 8, 0, 0));

        map.put(0x26CB, new Z80Instruction(Z80OpCodes.SLA, "SLA (HL)", 0x26CB, "26CB", 2, 15, 15, 0, 0));
        map.put(0xCBDD2600, new Z80Instruction(Z80OpCodes.SLA, "SLA (IX+nn)", 0xCBDD2600, "CBDD26(*1)", 4, 23, 23, 0, 0));
        map.put(0xCBFD2600, new Z80Instruction(Z80OpCodes.SLA, "SLA (IY+nn)", 0xCBFD2600, "CBFD26(*1)", 4, 23, 23, 0, 0));
        ...
        map.put(0xCBDD2E00, new Z80Instruction(Z80OpCodes.SRA, "SRA (IX+nn)", 0xCBDD2E00, "CBDD2E(*1)", 4, 23, 23, 0, 0));
        map.put(0xCBFD2E00, new Z80Instruction(Z80OpCodes.SRA, "SRA (IY+nn)", 0xCBFD2E00, "CBFD2E(*1)", 4, 23, 23, 0, 0));
        ...
        map.put(0xCBDD3E00, new Z80Instruction(Z80OpCodes.SRL, "SRL (IX+nn)", 0xCBDD3E00, "CBDD3E(*1)", 4, 23, 23, 0, 0));
        map.put(0xCBFD3E00, new Z80Instruction(Z80OpCodes.SRL, "SRL (IY+nn)", 0xCBFD3E00, "CBFD3E(*1)", 4, 23, 23, 0, 0));
        ...
        map.put(0x96DD, new Z80Instruction(Z80OpCodes.SUB, "SUB (IX+nn)", 0x96DD, "96DD(*1)", 3, 19, 19, 0, 0));
        map.put(0x96FD, new Z80Instruction(Z80OpCodes.SUB, "SUB (IY+nn)", 0x96FD, "96FD(*1)", 3, 19, 19, 0, 0));
        ...
        map.put(0xD6, new Z80Instruction(Z80OpCodes.SUB, "SUB nn", 0xD6, "D6(*1)", 2, 7, 8, 0, 0));

        map.put(0xAE, new Z80Instruction(Z80OpCodes.XOR, "XOR (HL)", 0xAE, "AE", 1, 7, 8, 0, 0));
        map.put(0xAEDD, new Z80Instruction(Z80OpCodes.XOR, "XOR (IX+nn)", 0xAEDD, "AEDD(*1)", 3, 19, 19, 0, 0));
        map.put(0xAEFD, new Z80Instruction(Z80OpCodes.XOR, "XOR (IY+nn)", 0xAEFD, "AEFD(*1)", 3, 19, 19, 0, 0));
        ...
        map.put(0xEE, new Z80Instruction(Z80OpCodes.XOR, "XOR nn", 0xEE, "EE(*1)", 2, 7, 8, 0, 0));
